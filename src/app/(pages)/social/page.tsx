...
import { SiWantedly, SiZenn, SiQiita } from "react-icons/si";
...
const socialLinks = [
  ...
  },
  {
    ...
    shadow: "hover:shadow-[0_0_20px_#181717] dark:hover:shadow-[0_0_20px_#ffffff]",
  },
  {
    name: "Zenn",
    url: "https://zenn.dev/your-profile",
    icon: SiZenn,
  ...
  {
    name: "Qiita",
    url: "https://qiita.com/your-profile",
    icon: SiQiita,
  ...
  {
    name: "Wantedly",
    url: "https://www.wantedly.com/id/your_profile",
    icon: SiWantedly,
    color: "group-hover:text-[#21c2b1]",
    shadow: "hover:shadow-[0_0_20px_#21c2b1]",
  },
];
              ...
              >
                <Link href={link.url} passHref legacyBehavior>
                  ...
                  >
                    ...
                    <span className={`text-xl font-semibold transition-colors duration-300 ${link.color}`}>
                      {link.name}
                    </span>
                  </a>
                </Link>
