...
const CareersPage: NextPage = () => {
  return (
    <div
      className={`min-h-screen pt-20 bg-[var(--color-light-bg)] dark:bg-[var(--color-dark-bg)] text-[var(--color-text-dark)] dark:text-[var(--color-text-light)] ${techMono.className}`}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <section className="mb-16">
          <h2
            className="text-3xl font-bold text-center mb-12 glitch"
            data-text="Open Positions"
          >
            Open Positions
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="border border-cyan-500 rounded-lg p-6 shadow-[0_0_15px_rgba(0,255,255,0.7)] bg-[var(--color-light-bg-secondary)] dark:bg-[var(--color-dark-bg-secondary)]">
              ...
              <Link
                href="/"
                className="w-full inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium h-10 px-4 py-2 bg-cyan-500 hover:bg-cyan-600 text-black font-bold"
              >
                Apply Now
              </Link>
            </div>
            ...
            <div className="border border-purple-500 rounded-lg p-6 shadow-[0_0_15px_rgba(128,0,128,0.7)] bg-[var(--color-light-bg-secondary)] dark:bg-[var(--color-dark-bg-secondary)]">
              ...
              <Link
                href="/"
                className="w-full inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium h-10 px-4 py-2 bg-purple-500 hover:bg-purple-600 text-black font-bold"
              >
                Apply Now
              </Link>
            </div>
            ...
            <div className="border border-green-500 rounded-lg p-6 shadow-[0_0_15px_rgba(0,255,0,0.7)] bg-[var(--color-light-bg-secondary)] dark:bg-[var(--color-dark-bg-secondary)]">
              ...
              <p className="text-gray-400 mb-4">
                Join our team as a UX/UI Designer to create intuitive and
                engaging...
              </p>
              <Link
                href="/"
                className="w-full inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium h-10 px-4 py-2 bg-green-500 hover:bg-green-600 text-black font-bold"
              >
                Apply Now
              </Link>
            </div>
